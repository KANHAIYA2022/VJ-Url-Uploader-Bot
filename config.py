...
class Config(object):
    # Bot Information 
    TECH_VJ_BOT_TOKEN = os.environ.get("TECH_VJ_BOT_TOKEN", "6510354086:AAGCjpupNSkg4w4H2xoDF-l0yTpna2URuBA")
    TECH_VJ_BOT_USERNAME = os.environ.get("TECH_VJ_BOT_USERNAME", "URLUPLOADERKANHA0BOT") # Bot username without @.
